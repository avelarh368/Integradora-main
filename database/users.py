...
for i in range(120):
    ...
    f.write("INSERT INTO USERS VALUES(\'US0"+str(i)+"\',\'"+first+str(randint(0,999))+"\',\'"+first+"\',\'"+names.get_last_name()+"\',\'"+str(pgen())+"\',\'"+str(randint(1000000000000000,9999999999999999))+"\',"+str(randint(0,1))+",\'"+str.lower(first)+str(randint(0,999))+"@"+dom(randint(1,10))+"\');\n")
